...
const GALLERY_IMAGES_BASE = [
    ...
    { name: "Helen and Jasmine", src: require("../../assets/gallery/helen_jasmine.png"), caption: "Miami, FL" },
    { name: "Mari's Grandmas", src: require("../../assets/gallery/grandmas.png"), caption: "Miami, FL" },
    { name: "Kenny and Clau", src: require("../../assets/gallery/kiko_fam.png"), caption: "Miami, FL" },
    { name: "Carlos' Family", src: require("../../assets/gallery/kiko_inlaw_1.png"), caption: "Miami, FL" },
    { name: "Carlos' Family", src: require("../../assets/gallery/kiko_inlaw_2.png"), caption: "Miami, FL" },
    { name: "Aunt Grethel", src: require("../../assets/gallery/aunt_grethel.png"), caption: "Miami, FL" },
    ...
    { name: "Kimmy and Rawabi", src: require("../../assets/gallery/rawabi.png"), caption: "Miami, FL" },
    ...
    { name: "Roomies", src: require("../../assets/gallery/keishla_nicole.png"), caption: "Gainesville, FL" },
